import { Bet, BetType, Spot } from '~/types';
...
export class BetHelper {
  ...
  static getBetTypeName(betType: BetType): string {
    switch (betType) {
      case BetType.STRAIGHT: return 'Straight';
      case BetType.SPLIT: return 'Split';
      case BetType.STREET: return 'Street';
      case BetType.CORNER: return 'Corner';
      case BetType.BASKET: return 'Basket';
      case BetType.SIXLINE: return 'Six Line';
      case BetType.RED: return 'Red';
      case BetType.BLACK: return 'Black';
      case BetType.EVEN: return 'Even';
      case BetType.ODD: return 'Odd';
      case BetType.LOW: return '1-18';
      case BetType.HIGH: return '19-36';
      case BetType.FIRST_DOZEN: return '1st Dozen';
      case BetType.SECOND_DOZEN: return '2nd Dozen';
      case BetType.THIRD_DOZEN: return '3rd Dozen';
      case BetType.FIRST_COLUMN: return '1st Column';
      case BetType.SECOND_COLUMN: return '2nd Column';
      case BetType.THIRD_COLUMN: return '3rd Column';
